...
// workaround for bug of Mocha importing Driver twice if using require('../src/driver')
    ...
    it('PUT to /api/drivers/id edits an existing driver', (done) => {
        ...
        driver.save().then(() => {
            request(app)
                ...
                .send({ driving: true })
                .end(() => {
                    Driver.findOne({ email: 't@t.com' }).then(
                        (updatedDriver) => {
    ...
    it('DELETE to /api/drivers/id deletes an existing driver', (done) => {
        ...
        driver.save().then(() => {
            ...
            request(app)
                ...
                .end((err, response) => {
                    Driver.findOne({ email: 'delete@me.com' }).then(
                        (deletedDriver) => {
